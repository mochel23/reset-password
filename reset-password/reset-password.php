...
<html>
    ...
    <div class="inline">
        ...
        <p>An Email will be sent to you with instructions on how to to reset your password.</p>
            ...
            <input type="text" name="email" placeholder="Enter your E-mail addresss...">
            <input type="submit" name="reset-request-submit" value="Receive new password by email." class="">
        </form>
        </div>
    </body>
</html>